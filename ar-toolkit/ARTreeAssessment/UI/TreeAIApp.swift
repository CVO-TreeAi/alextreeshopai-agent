...
/// Main TreeAI AR Tree Assessment App - Agent-Driven Version
@main
struct TreeAIApp: App {
...
#Preview {
    AgentDrivenContentView()
        .environmentObject(AgentCommunicationManager())
        .environmentObject(AgentDrivenWorkflowManager())
        .environmentObject(AgentDrivenSafety())
        .environmentObject(AgentDrivenTreeScore())
        .environmentObject(AgentDrivenARManager())
        .environmentObject(RealTimeAgentCoordinator(
        ...
        .environmentObject(AgentIntegrationTests())
        .environmentObject(AppState())
}